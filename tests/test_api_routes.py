...
EXPECTED_ROUTES = {
    ...
    ("/api/learned-rules", "POST"),
    ("/api/learned-rules/{rule_id}", "DELETE"),
    ("/api/learned-rules/{rule_id}", "GET"),
    ("/api/learned-rules/{rule_id}", "PUT"),
    ("/api/learned-rules/{rule_id}/active", "PATCH"),
    ("/api/learned-rules/{rule_id}/approve", "POST"),
    ("/api/learned-rules/{rule_id}/reject", "POST"),
